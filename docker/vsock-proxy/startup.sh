...
sleep 30s
ip link set address 0a:9d:f6:91:fb:73 dev fortanix-tap0 # This is ethernet address from parent 'ens5' device. This setting will be set using netlink in the future.
...
arp -i fortanix-tap0 -s 172.31.32.1 0a:63:7f:97:f3:c9	# This is a copy of ARP entries from parent instance. This setting will be set using netlink in the future.
