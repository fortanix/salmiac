...
pub fn open_async_packet_capture_with_port_filter(device_name : &str, mtu : u32, port : u32) -> Result<pcap_async::PacketStream, String> {
...
pub fn open_async_packet_capture(device_name : &str, mtu : u32) -> Result<pcap_async::PacketStream, String> {
    open_async_packet_capture0(device_name, async_packet_capture_config(mtu))
}

fn open_async_packet_capture0(device_name : &str, config : Config) -> Result<pcap_async::PacketStream, String> {
