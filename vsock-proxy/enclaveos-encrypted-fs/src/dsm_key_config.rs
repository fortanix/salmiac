...
pub trait DsmInterface {
    ...
    const OVERLAY_FS_SECURITY_OBJECT_PREFIX: &str;
    ...
    fn new(conn_info: ClientConnectionInfo<'_>) -> Result<DsmFsOps, String> {
...
#[cfg(feature = "opensource_sdkms_cli")]
